""" 
Note: This code is a COPY-PASTE from https://github.com/mit-crpg/opendeplete/blob/master/opendeplete/integrator/cram.py,
as coded for the opendeplete module, which is module to be used in combinationwith openMC.
The installation of the opendeplete repository is complex, and since I only reauired the CRAMsolve function, I just copied this file.
